...
import { Query, RequestMethod, createMocks } from "node-mocks-http";

import galleryHandler from "@/pages/api/gallery";
type MockReturn = { req: NextApiRequest; res: NextApiResponse };
const getMock = (method: RequestMethod, query?: Query): MockReturn =>
...
describe("Gallery API", () => {
  ...
  const invalidMethods: Array<RequestMethod> = [
    "PUT",
    "DELETE",
    "PATCH",
    "OPTIONS",
